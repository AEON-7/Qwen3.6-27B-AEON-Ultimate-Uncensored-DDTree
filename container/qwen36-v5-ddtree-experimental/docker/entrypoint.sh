...
case "$MODE" in
  ...
  ddtree-full)
    ...
    export DDTREE_FORCE_GREEDY_TREE_SAMPLER="${DDTREE_FORCE_GREEDY_TREE_SAMPLER:-1}"
    export DDTREE_CHAIN_SEED="${DDTREE_CHAIN_SEED:-true}"
    export DDTREE_CHAIN_SEED_LIMIT="${DDTREE_CHAIN_SEED_LIMIT:-8}"
    export DDTREE_DISABLE_EXTRA_ROOT_CHILDREN="${DDTREE_DISABLE_EXTRA_ROOT_CHILDREN:-1}"
    export DDTREE_MIN_ROOT_BRANCHES="${DDTREE_MIN_ROOT_BRANCHES:-0}"
    export DDTREE_ROOT_LEAF_ONLY="${DDTREE_ROOT_LEAF_ONLY:-0}"
    export DDTREE_ROOT_LEAF_ALT_COUNT="${DDTREE_ROOT_LEAF_ALT_COUNT:-4}"
    ...
    export DDTREE_SLOW_TREE_CONV="${DDTREE_SLOW_TREE_CONV:-0}"
    export DDTREE_INLINE_PARENT_FALLBACK="${DDTREE_INLINE_PARENT_FALLBACK:-0}"
    export DDTREE_FULL_BRANCH_FREEZE_MAMBA_POSTPROCESS="${DDTREE_FULL_BRANCH_FREEZE_MAMBA_POSTPROCESS:-1}"
    export DDTREE_FULL_BRANCH_REQUIRE_PREFIX="${DDTREE_FULL_BRANCH_REQUIRE_PREFIX:-1}"
    export DDTREE_DFLASH_COMPACT_CONTEXT_ROWS="${DDTREE_DFLASH_COMPACT_CONTEXT_ROWS:-1}"
    export DDTREE_MATERIALIZE_TREE_SAMPLE="${DDTREE_MATERIALIZE_TREE_SAMPLE:-1}"
    export DDTREE_BATCH_BRANCH_CONV_MIRROR="${DDTREE_BATCH_BRANCH_CONV_MIRROR:-1}"
    export DDTREE_BATCH_BRANCH_SSM_MIRROR="${DDTREE_BATCH_BRANCH_SSM_MIRROR:-1}"
