...
- M12: M72 branchguard benchmark path. This single finalizer milestone adds
  the full-branch prefix guard, tree-sample materialization controls, and
  batched branch conv/SSM state mirroring with indexed assignment. With the
  `ddtree-full` defaults in this branch, PP128/TG128/C1/N30 measured
