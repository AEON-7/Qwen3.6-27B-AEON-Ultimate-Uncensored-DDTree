...
[![Stable DFlash](https://img.shields.io/badge/stable%20path-vllm--aeon--ultimate--dflash-blue?logo=docker)](https://github.com/AEON-7/Qwen3.6-27B-AEON-Ultimate-Uncensored-DFlash)
[![Model](https://img.shields.io/badge/HuggingFace-Qwen3.6%20AEON%20Ultimate-yellow?logo=huggingface)](https://huggingface.co/AEON-7/Qwen3.6-27B-AEON-Ultimate-Uncensored-Multimodal-NVFP4-MTP-XS)
...
| Path | Purpose |
|---|---|
| [`container/qwen36-v5-ddtree-experimental/`](container/qwen36-v5-ddtree-experimental/) | Build context, entrypoint, patch scripts, prototypes, and tests for the current experimental DDTree container. |
| [`docs/ddtree-vllm-integration-plan.md`](docs/ddtree-vllm-integration-plan.md) | Working implementation plan for moving DDTree from prototype to vLLM-native support. |
| [`bench/results/`](bench/results/) | Raw benchmark and correctness artifacts from the DDTree investigation. |

This repository is intentionally separate from the stable production DFlash
repo. The stable repo is for users who want the best working Qwen3.6 serving
...
This digest includes the corrected OCI package metadata:
